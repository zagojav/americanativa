  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input id="telefone" name="telefone" className="mt-1 w-full rounded-md border border-dourado/40 px-3 py-2" />
      </div>
      <div>
        <label className="text-sm font-medium text-vinho" htmlFor="mensagem">Mensagem</label>
        <textarea required id="mensagem" name="mensagem" rows={4} className="mt-1 w-full rounded-md border border-dourado/40 px-3 py-2" />
      </div>
